	...
	-- 2. Main Debugger
	{
		...
		data = {
			...
			keys = {
				...
				{ lhs = "<leader>dU", rhs = ":lua require'dap'.up()<CR>",         mode = "n", desc = "Debug stack up" },
				{ lhs = "<leader>dD", rhs = ":lua require'dap'.down()<CR>",       mode = "n", desc = "Debug stack down" },
				{ lhs = "<leader>dui", rhs = ":lua require'dap-view'.toggle()<CR>", mode = "n", desc = "Debug toggle view" },
				{
					lhs = "<leader>d_",
