...
vim.keymap.set({ 'n', 't' }, '<C-h>', smart.move_cursor_left)
vim.keymap.set({ 'n', 't' }, '<C-j>', smart.move_cursor_down)
vim.keymap.set({ 'n', 't' }, '<C-k>', smart.move_cursor_up)
vim.keymap.set({ 'n', 't' }, '<C-l>', smart.move_cursor_right)
