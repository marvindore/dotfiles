vim.pack.add({
	{
		...
		data = {
			keys = {
				...
				{ lhs = "<leader>gg",  rhs = ":lua require('neogit').open({ kind = 'floating'})<cr>", mode = "n", desc =  "Neogit Open" },
				{ lhs = "<leader>gs",  rhs = ":lua require('gitsigns').show_commit()<cr>", mode = "n", desc =  "Show commit" },
				{ lhs = "<leader>]",   rhs = ":lua require('gitsigns').next_hunk()<cr>", mode = "n", desc =  "Git Next Hunk" },
				{ lhs = "<leader>[",   rhs = ":lua require('gitsigns').prev_hunk()<cr>", mode = "n", desc =  "Prev Next Hunk" },
				...
				{ lhs = "<leader>gp",  rhs = ":lua require('gitsigns').preview_hunk_inline()<cr>", mode = "n", desc =  "Preview Hunk" },
