...
function M.setup_lsp_attach()
  vim.api.nvim_create_autocmd("LspAttach", {
    callback = function(args)
      ...
      local picker_definition = has_fzf and function() fzf.lsp_definitions() end or vim.lsp.buf.definition
      local picker_references = has_fzf and function() fzf.lsp_references()  end or vim.lsp.buf.references
      local picker_implementations = has_fzf and function() fzf.lsp_implementations() end or vim.lsp.buf.implementation
      local picker_declaration = has_fzf and function() fzf.lsp_declarations() end or vim.lsp.buf.declaration
      local picker_typedefs = has_fzf and function() fzf.lsp_typedefs() end or vim.lsp.buf.type_definition
      local picker_symbols = has_fzf and function() fzf.lsp_document_symbols() end or function() vim.lsp.buf.document_symbol() end
      ...
      if client then
        ...
        elseif client.name == "roslyn" then
          ...
          map("n", "<leader>ise", function() require("easy-dotnet").secrets() end,               "Dotnet Secrets")
